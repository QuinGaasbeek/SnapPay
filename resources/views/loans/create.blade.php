            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-300 hover:shadow-3xl">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="w-full lg:w-2/3 p-8 lg:p-12">
                        ...
                        <form action="{{ route('loans.store') }}" method="POST" id="loanForm" class="space-y-8">
                            @csrf
                            <div class="space-y-8">
                                <div class="relative">
                                ...
                                <div class="flex flex-col sm:flex-row justify-end space-y-4 sm:space-y-0 sm:space-x-4 pt-6">
                                    <a href="{{ route('loans') }}" class="w-full text-center md:flex md:items-center sm:w-auto px-6 py-3 bg-gray-100 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3E92CC] transition-all duration-300 text-center">
                                        Annuleren
                                    </a>
