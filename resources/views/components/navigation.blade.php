    ...
    <div class="container mx-auto px-4">
        ...
        >
            <div class="px-2 pt-2 pb-3 space-y-1 bg-white/10 backdrop-blur-md rounded-lg mt-2">
                ...
                @guest
                    <a href="{{ route('login') }}" class="block px-4 py-2 rounded-full text-base font-medium text-white border border-white hover:bg-white hover:text-[#0A2463] transition-all duration-300">
                        Inloggen
                    </a>
                    <a href="{{ route('register') }}" class="block w-full text-center bg-white text-[#0A2463] px-4 py-2 rounded-full font-medium hover:bg-opacity-90 transition-all duration-300">
                        Registreer Nu
                    </a>
                @else
                    <a href="{{ route('dashboard') }}" class="block px-4 py-2 rounded-full text-base font-medium text-white border border-white hover:bg-white hover:text-[#0A2463] transition-all duration-300">
