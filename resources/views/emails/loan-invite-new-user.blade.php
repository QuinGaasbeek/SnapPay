...
<div class="container">
    ...
    <h2>Leningdetails:</h2>
    <ul>
        <li>Titel: {{ $loan->title }}</li>
        <li>Bedrag: €{{ number_format($loan->amount, 2, ',', '.') }}</li>
        <li>Looptijd: {{ $loan->period_count }} {{ Str::plural($loan->period, $loan->period_count) }}</li>
    </ul>

    <p>Klik op de onderstaande knop om je account aan te maken en de lening te bekijken:</p>

    <p>
        <a href="{{ $inviteUrl }}" class="button">Account aanmaken en lening bekijken</a>
    </p>
