    ...
    <div class="min-h-screen bg-gradient-to-br from-[#0A2463] to-[#3E92CC] py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
        <div class="w-full max-w-4xl bg-white/10 backdrop-filter backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden">
            <div class="p-8 sm:p-12">
                ...
                <form id="loanForm" action="<?php echo e(route('loans.store')); ?>" method="POST" class="space-y-8">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex flex-col sm:flex-row justify-between mt-8 gap-4 pb-20 sm:pb-0">
                        <a href="<?php echo e(route('loans')); ?>" class="w-full sm:w-auto px-6 py-3 bg-white/10 rounded-full text-white hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#0A2463] transition duration-300 text-center">
                            Annuleren
                        </a>
...
<?php /**PATH /Users/quingaasbeek/PhpstormProjects/SnapPayApplication/resources/views/loans/create.blade.php ENDPATH**/ ?>