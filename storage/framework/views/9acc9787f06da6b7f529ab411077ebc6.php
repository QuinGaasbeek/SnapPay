                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-white/5 backdrop-blur-sm rounded-xl p-6 shadow-lg transition-all duration-300 hover:bg-white/10">
                                <h4 class="text-xl font-medium text-white mb-4"><?php echo e($loan->title); ?></h4>
                                <div class="space-y-2 text-white/90">
                                    <p class="flex justify-between">
                                        <span>Bedrag:</span>
                                        <span class="font-semibold">€<?php echo e(number_format($loan->amount, 2, ',', '.')); ?></span>
                                    </p>
                                    <p class="flex justify-between">
                                        <span>Looptijd:</span>
                                        <span class="font-semibold"><?php echo e($loan->period_count); ?> <?php echo e(Str::plural($loan->period, $loan->period_count)); ?></span>
                                    </p>
                                </div>
                                <p class="mt-4 text-white/80 text-sm"><?php echo e(Str::limit($loan->description, 100)); ?></p>
                            </div>
                        ...
                        <div>
                            ...
                            <form method="POST" action="<?php echo e(route('register.invite.create')); ?>" class="space-y-6">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input id="first_name" type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" required autofocus class="w-full px-4 py-2 rounded-lg border border-white/30 bg-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 transition duration-200">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <input id="last_name" type="text" name="last_name" value="<?php echo e(old('last_name')); ?>" required class="w-full px-4 py-2 rounded-lg border border-white/30 bg-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 transition duration-200">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="email" type="email" name="email" value="<?php echo e($email); ?>" required readonly class="w-full px-4 py-2 rounded-lg border border-white/30 bg-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 transition duration-200">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input id="iban" type="text" name="iban" value="<?php echo e(old('iban')); ?>" class="w-full px-4 py-2 rounded-lg border border-white/30 bg-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 transition duration-200" placeholder="NL00 BANK 0123 4567 89">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <p class="text-white/80 text-center mt-8">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="font-medium text-white hover:underline transition duration-200">Log hier in</a>
                    </p>
                </div>
            </div>
        </div>
...
<?php /**PATH /Users/quingaasbeek/PhpstormProjects/SnapPayApplication/resources/views/auth/register-invite.blade.php ENDPATH**/ ?>